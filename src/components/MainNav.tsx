...
export function MainNav(props: ComponentProps<"nav">) {
    ...
    return (
        <nav class={cn("flex items-center space-x-4 lg:space-x-6", props.class)} {...rest}>
            ...
            <a href={Routes().dashboard.issues.index} class="text-sm font-medium transition-colors hover:text-white text-secondary" classList={{ "!text-white border-b leading-7": location.pathname === '/dashboard/issues' }}>
                Issues
            </a>
